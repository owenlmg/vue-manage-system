            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="是否轮播" >
                    <template slot-scope="scope">
                        <el-switch v-model="scope.row.is_slide" active-value="1" inactive-value="0" disabled="true"></el-switch >
                    </template>
                </el-table-column>
                <el-table-column prop="url" label="跳转地址" >
                </el-table-column>
                <el-table-column prop="icon" label="封面图片" >
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="40%">
            <el-form ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="是否轮播">
                    <el-switch  v-model="form.is_slide" active-value="1" inactive-value="0"></el-switch >
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            saveEdit() {
                ...
                this.$axios.post(this.path + '/activity/update', this.form)
            ...
            deleteRow(){
                ...
                let that = this;
                this.$axios.post(this.path + '/activity/delete', {'id':item.id})
                    .then(function (response) {
